...
RSpec.describe MessageFormatter do
  context "#format" do
    it do
      crypto1 = CryptoPair.new(exchange: Exchange.new('bittrex'), name: 'BTCUSD', bid: 5090, ask: 6000, volume_24h: 1_000_000)
      crypto2 = CryptoPair.new(exchange: Exchange.new('hitbtc'), name: 'BTCUSD', bid: 6060, ask: 6070, volume_24h: 2_000_000)
