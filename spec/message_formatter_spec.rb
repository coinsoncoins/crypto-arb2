...
RSpec.describe MessageFormatter do
  context "#format" do
    it do
      ...
      expected_message = "Buy LTC-BTC at bittrex at ask 0.06000000 ($360.0) (volume 1000000.0) and sell LTC-BTC at hitbtc at bid 0.06060000 ($363.6) (volume 2000000.0) for gain 1.0%. potential profit=$600.00.  Buy 5000 coins ($1800000.00)"
