...
RSpec.describe BittrexClient do
  context "#get_exchange" do
    it "returns the exchange data" do
      ...
      expected_crypto = Market.new(name: '1ST-BTC', bid: 0.00004186, ask: 0.00004188, volume_24h: 33.70546702)
  ...
  context "#get_order_book" do
    it do
      ...
      market = Market.new(name: 'NAV-BTC')
      order_book = bittrex_client.get_order_book(market)
