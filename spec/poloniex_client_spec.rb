...
RSpec.describe PoloniexClient do
  context "#get_exchange" do
    it "returns the exchange data" do
      ...
      expected_crypto = Market.new(name: 'BCN-BTC', bid: 0.00000024, ask: 0.00000025, volume_24h: 19.37260896)
  ...
  context "#get_order_book" do
    it do
      ...
      market = Market.new(name: 'VTC-BTC')
      order_book = poloniex_client.get_order_book(market)
