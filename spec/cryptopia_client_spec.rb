...
RSpec.describe CryptopiaClient do
  ...
  context "#get_exchange" do
    it "returns the exchange data" do
      ...
      expected_crypto = Market.new(name: '$$$-BTC', bid: 0.00000019, ask: 0.00000021, volume_24h: 0.07167655)
  ...
  context "#get_order_book" do
    it do
      ...
      market = Market.new(name: 'NEBL-BTC')
      order_book = cryptopia_client.get_order_book(market)
